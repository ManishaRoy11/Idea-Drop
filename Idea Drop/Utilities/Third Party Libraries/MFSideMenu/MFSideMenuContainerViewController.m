...
@property (nonatomic, strong) UIView *menuContainerView, *blurView;
...
//        _blurView.frame = CGRectMake(270, 0, SCREEN_WIDTH-270, SCREEN_HEIGHT);
//
//        [APP_DELEGATE.window addSubview:_blurView];
...
//        _blurView.frame = CGRectMake(0, 0, SCREEN_WIDTH-270, SCREEN_HEIGHT);
//
//        [APP_DELEGATE.window addSubview:_blurView];
